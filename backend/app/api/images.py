...
def get_image_details(
    ...
    return {
        ...
        "behavior": (detection.behavior if detection else None) or (t_sighting.behavior if t_sighting else None) or "-",
        "sex": (detection.sex if detection else None) or (tiger.sex if tiger else "-"),
        "age_class": (detection.age_class if detection else None) or (tiger.age_class if tiger else "-"),
        "direction": (detection.direction if detection else None) or (t_sighting.direction if t_sighting else None) or "-",
        "location_name": (detection.location_name if detection else None) or (t_sighting.location_name if t_sighting else None) or (station.name if station else "Pench Field Location"),
